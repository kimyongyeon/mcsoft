...
$("#Index_page").live("pageinit", function() {
    ...
    page.view = ( function() {
    	...
    	// selector 등록
    	var sel = {};
        sel.boardList = $('._boardList', page.dom);
    	
        var pub = {};        
        // board list move -> controller event call
        pub.onClickBoardList = function(callback) {
            sel.boardList.bind('click', function() {
                callback();
            });
        };
    ...
    page.controller = ( function() {
        ...
        pub.init = function() {
            ...
            // 작성 버튼 클릭
            page.view.onClickBoardList(function() {
                pcs.html.startActivity('../board/BoardList.html');
            });
