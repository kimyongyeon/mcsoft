...
$("#private_agree_page").live("pageinit", function() {
    ...
    page.view = ( function() {
    	...
    	// selector 등록
    	var sel = {};
        //sel.agree1 = $('._agree1', page.dom);
    	
        var pub = {};        
        // board list move -> controller event call
        /*pub.onClickAgree1 = function(callback) {
            sel.agree1.bind('click', function() {
                callback();
            });
        };*/
    ...
    page.controller = ( function() {
        ...
        pub.init = function() {
            ...
            // 이용약관 자세희 버튼 클릭
            /*page.view.onClickAgree1(function() {
                pcs.html.startActivity('private_agree.html');
            });*/
