...
<script type="text/javascript">
	...
	function fn_write() {
		...
		frm.target = "_self";
		frm.action = "/admin/code/middleInsert.do";
		frm.method = "post";
		frm.submit();	
	}
</script>
...
<body>
	...
	<!--상단메뉴 종료 -->	
			...
			<div id="content">
	            <p class="con_tit">코드관리&gt; 중분류코드등록</p>
	            ...
	            <table class="write_box">
	                ...
	                <tbody>
	                	<tr>
	                        ...
	                        <td>${main_code_info.main_nm}</td>
	                    </tr>
	                    <tr>
	                        <th scope="row">중분류코드명</th>
	                        <td><input type="text" class="ipt tit" id="middle_nm" name="middle_nm"/></td>
	                    </tr>
