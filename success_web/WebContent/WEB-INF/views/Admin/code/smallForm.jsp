...
<script type="text/javascript">
	...
	function fn_list() {
		...
		frm.target = "_self";
		frm.action = "/admin/code/middleInfo";
		frm.method = "post";
		frm.submit();	
	}
	...
	function fn_write() {
		...
		frm.target = "_self";
		frm.action = "/admin/code/smallInsert.do";
		frm.method = "post";
		frm.submit();	
	}
</script>
...
<body>
	...
	<!--상단메뉴 종료 -->	
			...
			<div id="content">
	            <p class="con_tit">코드관리&gt; 소분류코드등록</p>
	            ...
	            <table class="write_box">
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        ...
	                        <td>${middle_code_info.middle_nm}</td>
	                    </tr>
	                    <tr>
	                        <th scope="row">소분류코드명</th>
	                        <td><input type="text" class="ipt tit" id="small_nm" name="small_nm"/></td>
	                    </tr>
	            ...
	            <p class="btn_box"><button type="buton" onClick="javascript:fn_write();">등록</button><button type="button" onClick="javascript:fn_list();">이전</button></p>
	        </div>
	    </div>
	</div>
</form>
