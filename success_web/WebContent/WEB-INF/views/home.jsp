...
<body>
	...
	<h2>
		<c:choose>
			<c:when test="${!empty  USER_SESSION}">
				${USER_SESSION.user_name} 님 안녕하세요 : <a href="/User/UserLogout.do">LOGOUT</a>
			</c:when>
			<c:otherwise>
				<a href="/User/UserLoginForm.do">LOGIN</a>
			</c:otherwise>
		</c:choose>
	</h2>
	<p></p>
	...
	<div id="SERVER">
	    <h2>SERVER</h2>
	    <p>WEB Main Page Url [사용자]: http://220.123.134.42:8080/</p>
	...
	<h3> 최초작성일 2013년 10월 : 01일 / 마지막 수정일 2013년 11월 06일</h3>

	<div id="DATE"><span>2013. 11. 06</span> <em>엄진영</em></div>
